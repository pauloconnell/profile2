...
const DataVisualization2 = function () {
  ...
  return (
    <div className="bgSolid">
      ...
      <RowCard link1={null} dataUrl1="https://d3-challenge-4.pauloconnell.repl.co/" header1="Population Education by Location" title1="Population Education by Location"
          ...
          link2={null} dataUrl2="https://d3-challenge-2-New.pauloconnell.repl.co" header2="Doping in Biking" title2="Doping in Biking"
      ...
      <RowCard link1={null} dataUrl1="https://d3-Challenge-3.pauloconnell.repl.co" header1="Global Temperature History" title1="Global Temperature History"
