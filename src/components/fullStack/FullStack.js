...
const FullStack = function () {
  ...
  return (
    <div className="bgSolid ">
      ...
      <section className="width90">
        ...
        <RowCard link1="https://authentication-pug.glitch.me/" header1="Encrypted Authentication Using Passport and MongoDB" title1="This app encrypts login details, stores users details on
          ...
          imgSrc1="https://res.cloudinary.com/pollie/image/upload/v1610815824/Authenticate-Pug_awfw7d.png" imgAlt1="Full Stack app with encrypted secure login image " footer1="This app encrypts login details, stores users details on
                  database, and allows secure login with Passport.js"
          link2={null} header2="Slang Translation App" title2="This app converts from British spelling/slang to US and Vise-Versa"
       ...
       */}
        <RowCard link1={null} header1="Anonymous Message Board Web App" title1="This App allows anonymous users to set password protected content on database 'boards'"
        ...
        */}
        ...
        <RowCard link1={null} header1="Sudoku Solver Game" title1="This app implements Sudoku logic and solves any board using recursion"
          ...
          link2={null} header2="API Stock Price Checker" title2="This app takes user input, hits API to get stock price, hits Database to store likes for each stock from unique IP addresses, and shows comparision of likes."
